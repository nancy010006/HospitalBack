...
<body>
	<form id="dataform">
			<table>
				...
				<tr>
					<td>出生頭圍:</td>
					<td><input type="number" name="BirthHeadWidth">公分</td>
				</tr>
				<tr>
					<td>現在頭圍:</td>
					<td><input type="number" name="NowHeadWidth">公分</td>
				</tr>
				<tr>
				...
				<tr>
					<td>診斷</td>
					<td>
						<select name="Diagnosis" multiple="multiple" size="15" required/>
				...
				<tr>
					<td>第一次癲癇發作年齡:</td>
					<td><input type="number" name="SeizureOnset" required/>歲<input type="number" name="SeizureOnset" required/>個月<input type="number" name="SeizureOnset" required/>天 (沒有請填0)</td>
				</tr>
				<tr>
					<td>點頭癲癇</td>
					<td>
				...
				<tr>
					...
					<td>
						有<input type="radio" name="SeizureStatusWithFever" value="有" required/>
						無<input type="radio" name="SeizureStatusWithFever" value="無" required/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>focal spikes:</td>
					<td>
						<select name="FocalSpikes" multiple="multiple" size="9" required/>
							<option value="無">無</option>
				...
				<tr>
					<td>曾使用抗癲癇無效藥物:</td>
					<td>
						<select name="UsedAntiepilepticDrugs" multiple="multiple" size="17" required/>
							<option value="無">無</option>
				...
				<tr>
					<td>目前使用抗癲癇藥物:</td>
					<td>
						<select name="NowAntiepilepticDrugs" multiple="multiple" size="17" required/>
							<option value="無">無</option>
							<option value="Dilantin">Dilantin</option>
							<option value="Phenobarbital">Phenobarbital</option>
							<option value="Tegretol">Tegretol</option>
