...
$(document).ready(function() {
    ...
    $('#table tbody').on( 'dblclick', 'tr', function () {      
        var account = dataTable.rows(this).data()[0][1]; 
        // console.log(account); 
        location.href = "singleresponse.html?account="+account;
    });
    $("#detail").on("click", function(){
        ...
        if(length>1){
            ...
            var account = dataTable.rows('.selected').data()[0][1];
            location.href = "singleresponse.html?account="+account;
        }
    });
...
function filter(){
    ...
    var data ={"data": [{"act":"DataTablegetUser"},{"type":which[1]}]};
    ...
    dataTable = $('#table').DataTable( {
        ...
        "serverSide": true,
        "ajax":{
            url :"../../model/user/controller.php", // json datasource
